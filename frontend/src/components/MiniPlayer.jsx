...
export default function MiniPlayer({ book, queue = [], onClose, onOpen, onPlay, onPlayFromQueue }) {
  ...
  return (
    <div className="fixed bottom-4 sm:bottom-8 left-1/2 -translate-x-1/2 w-full max-w-2xl px-4 sm:px-6 z-50 safe-area-bottom" style={{ paddingBottom: 'max(1rem, env(safe-area-inset-bottom))' }}>
      <div className="glass-panel border border-primary/20 rounded-2xl p-3 sm:p-4 flex items-center justify-between gap-3 shadow-2xl">
