      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        {continueBook && (
          <section className="mb-10">
            ...
            <div className="flex items-center gap-3 sm:gap-4 p-4 rounded-xl bg-slate-800/40 border border-slate-700/50 min-h-[88px]">
              ...
              <button
                ...
                className="shrink-0 px-4 py-3 sm:py-2 rounded-lg bg-primary text-white font-medium text-sm hover:bg-primary/90 transition-colors min-h-[44px]"
              >
                Continue
              </button>
            </div>
